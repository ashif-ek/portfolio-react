              ...
              <div className="relative overflow-hidden h-48">
                ...
                >
                  {project.link && project.link !== '#' ? (
                    ...
                    <span className="px-4 py-2 bg-gray-700/50 text-gray-400 rounded-lg text-sm font-medium cursor-not-allowed">
                      Coming Soon
                    </span>
                  )}
                  {project.github && project.github !== '#' && (
                    <a 
                      ...
                      className="p-2 bg-gray-800/80 text-gray-300 rounded-lg hover:text-white transition-colors"
