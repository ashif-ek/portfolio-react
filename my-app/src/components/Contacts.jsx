...
// --- SVG Icon Components ---
// Using components for icons makes the JSX cleaner and more reusable.
...
function Contact() {
  ...
  useEffect(() => {
    if (state.succeeded) {
      ...
      // Optionally, reset the formspree state itself if needed, though not typically necessary
