...
// A simple animated counter for stats (No changes needed here)
...
const About = () => {
 ...
 return (
    <section id="about" className="py-16 md:py-24 bg-[#0d1117] text-gray-200 relative overflow-hidden">
                ...
                <div className="flex flex-wrap justify-center border-b border-gray-700 mb-6">
                    {Object.keys(tabs).map(tab => (
                        <button 
                            ...
                            className={`px-4 sm:px-6 py-3 font-medium text-sm transition-all duration-300 relative ${activeTab === tab ? 'text-cyan-400' : 'text-gray-400 hover:text-white'}`}
                        >
                            {tabs[tab].title}
